      ...
      <View style={[styles.inputWrapper, styleOverride]}>
        ...
        <View style={styles.inputRow}>
          <TextInput
            ...
            style={[styles.input, { borderColor: showError ? "red" : valid && form[name] ? "green" : "#666" }]}
          />
          {secure && (
          ...
          {valid ? <Ionicons name="checkmark-circle" size={20} color="green" /> : showError ? <Ionicons name="alert-circle" size={20} color="red" /> : <View style={styles.iconPlaceholder} />}
        </View>
      </View>
    );
  };
          ...
          <View style={styles.formWrapper}>
            ...
            <View style={styles.row}>
              ...
              <View style={styles.pickerWrapper}>
                ...
                <View style={[styles.pickerContainer, { borderColor: form.emergRelation ? "green" : "#666" }]}>
                  <Picker selectedValue={form.emergRelation} onValueChange={(v) => handleChange("emergRelation", v)} dropdownIconColor="#fff">
            ...
            {renderInput("И-мэйл", "email", "example@mail.com", false, "email-address")}
            {renderInput("Нууц үг", "password", "Нууц үг оруулна уу", true)}
            {renderInput("Нууц үг давтах", "password2", "Давтан оруулна уу", true)}
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: "bold", textAlign: "center", color: "#000", marginBottom: 16 },
  ...
  submitButton: { backgroundColor: "#4CAF50", padding: 14, borderRadius: 8, marginTop: 10 },
  submitText: { color: "white", textAlign: "center", fontWeight: "bold" },
  errorText: { textAlign: "center", color: "#f00", marginTop: 10 },
});